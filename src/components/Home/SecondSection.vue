...
<template>
    <section class="pt-28">
        ...
        <div class="absolute inset-0 z-[2] custom-box-shadow"></div>
        <div class="absolute inset-0 z-[1] bg-gradient"></div>
    </section>
</template>
...
.custom-box-shadow {
    box-shadow: rgb(255, 255, 255) 0px 150px 200px inset, rgb(255, 255, 255) 0px -200px 200px inset;
}
</style>