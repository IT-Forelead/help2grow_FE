<script setup>
import RectangleSvg from '../../assets/icons/RectangleSvg.vue'
                ...
                <div class="col-span-12 md:col-span-8">
                    ...
                    <!-- <div class="grid grid-cols-2 gap-4 mt-8">
                        <div>
                            ...
                            <p class="text-base text-gray-600 leading-5 -tracking-[0.01em]">
                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sunt commodi, hic dolore praesentium doloremque maxime, cum tempora rerum deleniti, in molestiae corrupti eos porro.
                            </p>
                        </div>
                        <div>
                            <h2 class="mb-2 text-lg font-semibold leading-6 tracking-tight text-gray-900">
