...
<template>
  <div class="my-3">
    ...
    <button @click="addTask()"
      class="w-full focus:outline-none text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Add
      Task</button>
  </div>
</template>
